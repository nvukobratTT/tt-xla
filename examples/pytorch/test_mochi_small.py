#!/usr/bin/env python3
"""Test: Mochi transformer with torch.compile + minimal inputs to fit DRAM."""
...
# MINIMAL inputs — 16x16 spatial, 3 frames, 8 text tokens
h, w, f, t = 16, 16, 3, 8
